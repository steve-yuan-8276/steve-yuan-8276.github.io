...
* 一是 ssh-keygen 的详细用法，参见[ssh-keygen 中文手册][4]

* 二是前面生成密钥的会显示地址，记住这个地址，需要把id\_rsa.pub 的内容复制出来，后面会用到。
...
进入编辑界面后按i 开始编辑；把刚才复制的id\_rsa.pub  内容复制到里面，稳妥起见，前面可以加一行注释，注释已#开头；
...
##### 使用root登录修改配置文件：/etc/ssh/sshd\_config
...
[1]:	http://mirrors.sohu.com/centos/
[2]:	http://mirrors.163.com/centos/
[3]:	https://mirrors.aliyun.com/centos/
[4]:	http://www.jinbuguo.com/openssh/ssh-keygen.html